...
// 2. GENERATE HALAMAN KOTA & SITEMAP (URL BERSIH)
let sitemapEntries = '';
const baseUrl = 'https://cvbuilder.guidify.app';
...
console.log(`✨ Sukses! 465 Halaman CV Builder sudah siap di domain cvbuilder.guidify.app`);